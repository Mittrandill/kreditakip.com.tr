...
const riskAnalysisSchema = {
  ...
  properties: {
    ...
    overallRiskSummary: { type: SchemaType.STRING as const, description: "Genel özet (2-3 cümle)" },
    dtiPercentage: { type: SchemaType.NUMBER as const, description: "Borç/Gelir oranı yüzdesi" },
    dtiAssessment: { type: SchemaType.STRING as const, description: "DTI değerlendirmesi" },
    ...
    keyRiskFactors: {
      ...
      items: {
        ...
        properties: {
          ...
          severity: { type: SchemaType.STRING as const, enum: ["Düşük", "Orta", "Yüksek"] },
    ...
    recommendations: {
      ...
      items: {
        ...
        properties: {
          ...
          priority: { type: SchemaType.STRING as const, enum: ["Düşük", "Orta", "Yüksek"] },
