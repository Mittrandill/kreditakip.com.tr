      ...
      <Card className="border-gray-200 dark:border-gray-800">
        <CardHeader className="pb-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-xl text-gray-900 dark:text-white">Akıllı Filtreler</CardTitle>
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Verilerinizi detaylı analiz edin</p>
              </div>
            </div>
        ...
        <CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            {/* Quick Stats */}
            <div className="flex items-center justify-center gap-4 text-sm text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-800 rounded-lg px-4 py-2 border border-gray-200 dark:border-gray-700">
            ...
            <TabsContent value="overview" className="space-y-6 mt-0">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <Card className="border-gray-200 dark:border-gray-800 hover:shadow-lg transition-shadow">
                  <CardHeader className="pb-4">
                    <CardTitle className="flex items-center gap-2 text-lg dark:text-white">
                      <div className="p-2 bg-gradient-to-br from-teal-500 to-teal-600 dark:from-teal-600 dark:to-teal-700 rounded-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="border-gray-200 dark:border-gray-800 hover:shadow-lg transition-shadow">
                  <CardContent className="p-6">
                    ...
                    <h3 className="font-semibold text-lg text-gray-900 dark:text-white mb-2">Ödeme Performansı</h3>
                    <p className="text-3xl font-bold text-gray-900 dark:text-white mb-3">{formatPercent(summaryMetrics.paymentPerformance / 100)}</p>
                ...
                <Card className="border-gray-200 dark:border-gray-800 hover:shadow-lg transition-shadow">
                  <CardContent className="p-6">
                    ...
                    <h3 className="font-semibold text-lg text-gray-900 dark:text-white mb-2">Ortalama Faiz</h3>
                    <p className="text-3xl font-bold text-gray-900 dark:text-white mb-3">%{summaryMetrics.averageInterest.toFixed(1)}</p>
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                      Piyasa ortalamasının{" "}
                      <span
                        className={`font-semibold ${summaryMetrics.averageInterest > 15 ? "text-red-600 dark:text-red-400" : "text-emerald-600 dark:text-emerald-400"}`}
                      >
                ...
                <Card className="border-gray-200 dark:border-gray-800 hover:shadow-lg transition-shadow">
                  <CardContent className="p-6">
                    ...
                    <h3 className="font-semibold text-lg text-gray-900 dark:text-white mb-2">Aylık Yük</h3>
                    <p className="text-3xl font-bold text-gray-900 dark:text-white mb-3">{formatCurrency(summaryMetrics.monthlyPayment)}</p>
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                      <span className="font-semibold text-gray-900 dark:text-white">{summaryMetrics.activeCredits}</span> aktif krediden
                      toplam aylık ödeme
                    </p>
              ...
              <Card className="border-gray-200 dark:border-gray-800 hover:shadow-lg transition-shadow">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2 text-xl dark:text-white">
                    <div className="p-2 bg-gradient-to-br from-green-500 to-green-600 dark:from-green-600 dark:to-green-700 rounded-lg">
                      <TrendingUp className="h-6 w-6 text-white" />
                    </div>
                    Detaylı Trend Analizi
                  </CardTitle>
                  <p className="text-gray-600 dark:text-gray-400">12 aylık ödeme performansı ve trend analizi</p>
                </CardHeader>
                <CardContent>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <Card className="border-gray-200 dark:border-gray-800">
                      <CardContent className="text-center p-6">
                        <div className="text-4xl font-bold mb-2 text-emerald-600 dark:text-emerald-400">
                          {formatPercent(summaryMetrics.paymentPerformance / 100)}
                        </div>
                        <div className="text-sm font-medium text-gray-900 dark:text-white">Genel Performans</div>
                    ...
                    <Card className="border-gray-200 dark:border-gray-800">
                      <CardContent className="text-center p-6">
                        <div className="text-4xl font-bold mb-2 text-red-600 dark:text-red-400">{summaryMetrics.overduePayments}</div>
                        <div className="text-sm font-medium text-gray-900 dark:text-white">Geciken Ödemeler</div>
                        <div className="text-xs mt-2 text-gray-600 dark:text-gray-400">
                          {formatCurrency(
                            filteredPayments
                              .filter((p) => p.status === "overdue")
                    ...
                    <Card className="border-gray-200 dark:border-gray-800">
                      <CardContent className="text-center p-6">
                        <div className="text-4xl font-bold mb-2 text-teal-600 dark:text-teal-400">{summaryMetrics.upcomingPayments}</div>
                        <div className="text-sm font-medium text-gray-900 dark:text-white">Yaklaşan Ödemeler</div>
                        <div className="text-xs mt-2 text-gray-600 dark:text-gray-400">Sonraki 7 gün</div>
                      </CardContent>
                    </Card>
                  </div>
                      ...
                      {chartData.bankDistribution.slice(0, 5).map((bank, index) => (
                        ...
                        >
                          <div className="flex items-center gap-4">
                            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-emerald-500 to-emerald-600 dark:from-emerald-600 dark:to-emerald-700 flex items-center justify-center text-sm font-bold text-white">
                              {index + 1}
                            </div>
                            <div className="flex items-center gap-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Card className="border-gray-200 dark:border-gray-800 hover:shadow-lg transition-shadow">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-600 dark:text-gray-400 text-sm font-medium">Yaklaşan Ödemeler</p>
                ...
                <p className="text-teal-600 dark:text-teal-400 text-xs mt-1 font-medium">
                  {
        ...
        <Card className="border-gray-200 dark:border-gray-800 hover:shadow-lg transition-shadow">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-600 dark:text-gray-400 text-sm font-medium">Geciken Ödemeler</p>
                <p className="text-2xl font-bold mt-1 text-gray-900 dark:text-white">
                  {formatCurrency(
                    filteredPayments
                      .filter((p) => p.status === "overdue")
              ...
              <div className="p-3 bg-gradient-to-br from-red-500 to-red-600 dark:from-red-600 dark:to-red-700 rounded-xl shadow-sm">
        ...
        <Card className="border-gray-200 dark:border-gray-800 hover:shadow-lg transition-shadow">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-600 dark:text-gray-400 text-sm font-medium">Finansal Özet</p>
                <p className="text-2xl font-bold mt-1 text-gray-900 dark:text-white">{formatCurrency(summaryMetrics.totalPaidAmount)}</p>
                <p className="text-emerald-600 dark:text-emerald-400 text-xs mt-1 font-medium">Toplam Ödenen</p>
              </div>
              <div className="p-3 bg-gradient-to-br from-emerald-500 to-emerald-600 dark:from-emerald-600 dark:to-emerald-700 rounded-xl shadow-sm">
                <TrendingUp className="h-6 w-6 text-white" />
              </div>
