      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">Temel Kart Bilgileri</CardTitle>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">Kart Sahibi ve Detayları</CardTitle>
