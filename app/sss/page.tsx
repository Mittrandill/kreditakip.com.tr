  ...
  const faqs = [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: "Ücretsiz plan 1 döküm analizi yapabilir, temel ödeme planları oluşturabilir ve kredi takibi yapabilirsiniz. Premium özelliklere erişim için Pro planımızı inceleyebilirsiniz.",
        },
        {
      ...
      questions: [
        {
          ...
          a: "Evet, verileriniz AES-256 Şifreleme ile korunmaktadır. KVKK uyumlu süreçlerimiz ile maksimum güvenlik sağlıyoruz. Verileriniz hiçbir şekilde üçüncü taraflarla paylaşılmaz.",
        },
        {
