...
VALUES
  ('premium-monthly', 'Premium Aylık', 199.00, 'TRY', 'monthly',
   '["Sınırsız OCR analizi", "Finansal sağlık analizi", "Reklamsız deneyim", "Öncelikli destek"]'::jsonb,
   true),
  ('premium-yearly', 'Premium Yıllık', 1990.00, 'TRY', 'yearly',
   '["Sınırsız OCR analizi", "Finansal sağlık analizi", "Reklamsız deneyim", "Öncelikli destek", "%17 indirim"]'::jsonb,
   true);
\`\`\`
